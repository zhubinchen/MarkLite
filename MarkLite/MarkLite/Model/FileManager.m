...
//#define UBIQUITY_CONTAINER_URL @"iCloud.com.Bingcheng.MarkLite"
...
//        _local = [self createWorkspace:StorageTypeLocal];
//        _cloud = [self createWorkspace:StorageTypeCloud];
//        _local = [self createWorkspace:StorageTypeDropbox];
    }
    return self;
}

//- (Item*)createWorkspace:(StorageType)type
//{
//    NSArray *allWorkspaces = @[localWorkspace(),cloudWorkspace(),dropboxWorkspace()];
//    NSString *workspace = allWorkspaces[type];
...
//    root.storageType = type;
//    root.path = ZHLS(@"NavTitleCloudFile");
//    root.open = YES;
//    root.root = YES;
...
//}
//
//- (void)createDropboxWorkspace
//{
//    NSString *wokspace = dropboxWorkspace();
//    if (![fm fileExistsAtPath:wokspace]) {
//        
//        [fm createDirectoryAtPath:wokspace withIntermediateDirectories:YES attributes:nil error:nil];
//        NSLog(@"creating localWorkSpace:%@",wokspace);

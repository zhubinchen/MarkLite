...
//  zbd
//
//  Created by zhubch on 2017/7/19.
...
public let IAP = ZBDIAPHelper.sharedInstance
...
public class ZBDIAPHelper: NSObject {
    ...
    static let sharedInstance = ZBDIAPHelper()
...
extension ZBDIAPHelper {
    
    public func requestProducts(_ productIdentifiers: [ProductIdentifier], handler: @escaping ProductsRequestHandler) {
...
extension ZBDIAPHelper: SKProductsRequestDelegate {
...
extension ZBDIAPHelper: SKPaymentTransactionObserver {
